...
namespace Math
namespace GateGAmbientCriticalAlgebraicity
...
theorem isAlgebraic_of_equations_and_normalCriticality_in_ambient
  ...
  have hqE :
    ...
    GateGLexDifferentialScratch.isAlgebraic_of_equations_and_normalCriticality
...
end GateGAmbientCriticalAlgebraicity
end Math
