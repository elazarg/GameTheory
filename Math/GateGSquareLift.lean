...
namespace Math
namespace GateGSquareLiftScratch
...
theorem exists_radial_lexSelected_squareLift
  ...
  obtain ⟨y, hyS, hystrict, hymax, hylex⟩ :=
    Math.GateGLexSelection.score_ne_zero_of_exists_nonzero_of_lexMinOn_maximizers
        S
