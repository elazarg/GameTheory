...
import Math.GateGGermAlgebraicRelation
import Math.GateGRelativeLexAlgebraicity
...
namespace Math
namespace GateGLocalizedSeparableRelation

open GateGAlgebraicRelation
open GateGGermAlgebraicRelation
open GateGGermChart
open GateGGermComponentScratch
open GateGRelativeLexAlgebraicity
...
theorem localizedGermParameterAlgHom_injective
    ...
    letI : Algebra (Polynomial ℝ)
        (MvPolynomial σ ℝ ⧸ J) :=
      GateGFunctionField.parameterPolynomialAlgebra
        J parameter
...
end GateGLocalizedSeparableRelation
end Math
