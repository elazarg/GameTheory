...
import experiments.QuittingElementaryTailSemanticReduction
...
must contain the `card ι + 2` elementary boundary pairs, be invariant under
every one-stage product-root prefix, and carry the proposed debt floor.
Finite backward induction then covers every elementary capped word.
...
#print axioms finiteElementarySemanticReachable_subset_carrier
#print axioms attainable_subset_closure_finiteElementarySemanticReachable
#print axioms terminalSemanticCarrier_eq_closure_finiteElementarySemanticReachable
#print axioms finitePrefixSemanticEval_mem
#print axioms globalDebtFloor_of_certificate
#print axioms behavioralDebtFloor_of_certificate
#print axioms nonempty_certificate_iff_globalDebtFloor
#print axioms hasTerminalExploitabilityGap_of_certificate
#print axioms not_exists_uniformEquilibriumPayoff_of_certificate
