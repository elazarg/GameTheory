...
Compiled-model structure, adequacy, and recall obligations for the EFG
`ObsModelCore` translation. The theorem-facing Kuhn assembly lives in
...
noncomputable def treeHeight : GameTree S Outcome → Nat
  | .terminal _ => 0
...
theorem lastState_terminal_of_pureRun_height
    {π : ObsModelCore.PureProfile (compiledCoreObs t)}
    {ss : List (GameTree S Outcome)}
    (h :
      Math.ParameterizedChain.pureRun
