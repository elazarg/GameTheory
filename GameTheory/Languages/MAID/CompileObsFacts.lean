...
/-!
# MAID compiled ObsModelCore facts

Compiled-model structure, adequacy, and recall obligations for the MAID
perfect-recall `ObsModelCore` translation. The native Kuhn theorem assembly lives
in `GameTheory.Languages.MAID.Kuhn`.
-/
