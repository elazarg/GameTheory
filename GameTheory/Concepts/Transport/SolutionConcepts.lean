...
/-!
# Solution-Concept Transport

Optional umbrella for expected-utility-isomorphism invariance theorems whose
definitions live in separate equilibrium, potential, welfare, and zero-sum
clusters.
-/
