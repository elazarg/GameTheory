...
`GameTheory.Concepts.Stochastic.Equilibrium.Uniform` states `IsUniformEquilibriumPayoff`
...
`G.infinitePlayMeasure` (`GameTheory.Concepts.Stochastic.Core.Probability.InfinitePlayMeasure`)
