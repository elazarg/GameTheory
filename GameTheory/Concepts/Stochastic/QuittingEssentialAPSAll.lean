...
import GameTheory.Concepts.Stochastic.QuittingEssentialAPSConvexFixedPoint
...
operator, its carrier-restricted greatest fixed point, convex-fiber and
unique-successor progress extraction, the zero-mass regression, and the
