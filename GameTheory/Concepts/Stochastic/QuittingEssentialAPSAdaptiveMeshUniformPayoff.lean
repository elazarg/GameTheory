...
import GameTheory.Concepts.Stochastic.QuittingEssentialAPSInfiniteRun
import GameTheory.Concepts.Stochastic.QuittingInfiniteVariableSingletonMeshCertificate
  ...
  have hpath :=
    isUniformEquilibriumPayoff_of_proper_flesch_infiniteSingletonPath_of_windowMass_atTop
      reward successor owner mass value hgapPos hbound.le hreward hmass0
        hmassLt harc hactive hownerNext hgap hviable hvalueBound htotal
