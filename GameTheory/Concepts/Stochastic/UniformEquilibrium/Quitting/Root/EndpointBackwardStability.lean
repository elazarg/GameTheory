...
import GameTheory.Concepts.Stochastic.UniformEquilibrium.Quitting.Paths.OpponentActionMass
...
`GameTheory.Concepts.Stochastic.UniformEquilibrium.Quitting.Root.SuccessorCertificate`: is an
