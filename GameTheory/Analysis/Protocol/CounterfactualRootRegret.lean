...
game-independent finite aggregation theorem.  Its semantic premise is an
exact scalar root-gain decomposition; D48 supplies that premise for bounded
common-depth topological chains.  No second runner or regret semantics is
introduced here.
-/
