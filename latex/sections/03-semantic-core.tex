...
genuinely EU-only variants — which preserve each player's mean but
not the full payoff law — are the explicitly specialized
\TT{EUMorphism} and \TT{EUGameIsomorphism}.
...
properties and the \TT{ofEU} round-trip.  Supplement~§2.6.}
