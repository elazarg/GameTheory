...
\TT{Concepts/UtilityInvariance.lean} package the standard
solution-concept transport results; \TT{Concepts/EUProperties.lean}
and \TT{Concepts/OfEUProperties.lean} record EU structural
...
\leancorr{\TT{Concepts/GameMorphism.lean},
\TT{Concepts/UtilityInvariance.lean}, and
...
\leancorr{All three in \TT{Concepts/GameFormSolutionConcepts.lean}
