...
a one-shot FOSG'' is mechanized as a utility-distribution-preserving
kernel-game morphism (\TT{NFGGame.toFOSG\_morphism}), though not yet
packaged as an \TT{Expressiveness} reduction; comparisons that are not in the
...
games, finite information-design primitives, a finite
revelation-principle formulation, social-choice machinery, and
auction fragments (Vickrey, first-price, all-pay, VCG) are
formalized as consumers of the library.  The auction layer is
