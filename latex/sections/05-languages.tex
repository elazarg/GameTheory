...
intrinsic analogue of Kuhn's theorem.  If the information structure
admits a causal order and the player has perfect recall along that
order, then the conditional behavioral strategy extracted from a
mixed plan preserves the full outcome law against every opponent profile.
...
order-independent reasoning.  It compiles to \KG\ when supplied with
solvability and expected-utility data, but no cross-language bridge
