...
the Shapley-in-core theorem for games with nonnegative
...
the full Shapley~\citeyear{Shapley1971} theorem that every convex
game has a nonempty core and that the Shapley value lies in it;
Kalai–Smorodinsky
...
The finite substrate is now formalized in
...
\Cref{sec:mech:bayesian}.

Natural extensions are substantive theorems over this substrate:
finite concavification and value-of-information results, optimal
signal existence on a bounded finite message alphabet, explicit
finite signaling-game refinements, multi-receiver information
design, and bridges from persuasive decision rules to direct
mechanisms.  Continuous type spaces and compact belief simplices
