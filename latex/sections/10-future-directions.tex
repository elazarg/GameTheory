...
(\Cref{sec:solution-concepts:regret}), making the CFR convergence
proof a natural consumer.  This would also produce a
constructive CCE existence theorem
(\Cref{sec:theorems:correlated-existence}) without going through
Brouwer.
...
\emph{absent-minded-driver} phenomenon~\citep{PiccioneRubinstein1997}
...
Shapley value~\citep{Shapley1953} and the four classical axioms, with
linearity represented in Lean by additivity plus scalar homogeneity,
...
games~\citep{AumannShapley1974}; NTU coalitional games;
Shapley's~\citeyear{Shapley1971} theorem that convex games have
nonempty cores (and the Shapley value is in the core); Kalai–Smorodinsky
\citep{KalaiSmorodinsky1975} and other bargaining solutions.
...
\Cref{sec:mech:bayesian} and would benefit from a continuous-type
