...
efficiency plus universal domain, remains open;\ it is statable on
the existing social-choice setup, its proof is combinatorial and
does not require probability, and it would fit the library cleanly.
