...
rationality layer.  Two classical companions remain open.
...
function with full range over $\ge 3$ alternatives is manipulable;
it reduces to Arrow through an induced social-welfare function, the
natural next step on the existing rationality layer.
\emph{Sen's liberal paradox}~\citep{Sen1970} shows that even a
minimal individual-rights condition is inconsistent with Pareto
efficiency plus universal domain.  Both remaining results are
