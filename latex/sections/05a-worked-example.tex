...
whose NFG-level form is \TT{IsNashPure}, unfolds to
\[
...
bridge lemma
\TT{NFG.NFGGame.toFOSG\_udist\_eq} makes the joint payoff law of
every pure profile in the FOSG agree with that of the NFG; packaged
as the utility-distribution-preserving morphism
\TT{NFGGame.toFOSG\_morphism}, it transports the Nash property, so
$\Profile^*$ remains an equilibrium of the FOSG image
(\Cref{thm:transport}).
