...
contents), Cournot duopoly (a richer payoff matrix with
discrete quantities and a $\textsf{q}_2{=}\textsf{q}_2$ Nash),
Bertrand price competition, and the Braess-paradox welfare
inequality.  The analogous EFG examples — a two-stage centipede
illustrating backward induction with the welfare-paradoxical
$(1,0)$ outcome, and the three-offer Ultimatum game — are
recorded in \TT{Languages/EFG/Examples.lean}.
