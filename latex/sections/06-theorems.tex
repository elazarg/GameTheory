...
\S\ref{sec:languages:multiround}.  For a kernel game $\KG$, write
...
\begin{theorem}[Approximate discounted folk theorem]
...
discounted repeated game over $\KG^{\mathrm{mix}}$:\ for every
...
strategy.  This avoids adding sampled action histories or
correlated public randomization to the language layer.  A richer
behavioral repeated-game semantics could refine the interface
later; the payoff-set and trigger-strategy proof already isolate
the main analytic work.}
