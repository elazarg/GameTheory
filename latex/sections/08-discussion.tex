...
The library now proves an approximate discounted folk theorem
directly on \TT{KernelGame} streams
(\Cref{thm:folk-discounted}), but the concrete repeated- and
stochastic-game language layers remain bounded-horizon.  We have
not formalized infinite-horizon stochastic games with state
