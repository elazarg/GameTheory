...
non-cooperative core) defines the Shapley value with all four
classical axioms, the unanimity-basis decomposition, and the full
Shapley uniqueness theorem (\Cref{thm:shapley-unique});\ it also
includes the Banzhaf and Shapley–Shubik power indices, simple
games, convex (supermodular) games with the
$\IsConvex \Leftrightarrow$ monotone-marginals
