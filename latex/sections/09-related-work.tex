...
\citet{Selten1965} introduces subgame perfection, the refinement
connected here to the one-shot deviation principle;
\citet{Selten1975} introduces trembling-hand perfection, which is
not one of the theorem statements formalized in this chapter.
...
theorem itself is supplied by the standalone \TT{fixed-point-theorems-lean4}
