...
for some $n$.  Most theorems require \TT{Fintype} on the player
type $\Players$ and on each strategy type $\Strat_i$; some
require \TT{DecidableEq} as well, e.g.\ everything that uses
...
product of a finite family of $\PMF{\cdot}$'s, used in the mixed
extension of a kernel game).
