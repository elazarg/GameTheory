...
Most \emph{existence theorems} (Nash, correlated equilibrium,
Zermelo, Kuhn) carry finite hypotheses where the proof genuinely
needs them — Brouwer's fixed point on a product of simplices,
\TT{Finite.exists\_max}, or an enumeration of pure strategies.
