...
behavioral/mixed equivalence, a finite von Neumann--Morgenstern
expected-utility representation theorem, Shapley-value uniqueness,
Gale--Shapley stable matching, and the lattice structure of stable
matchings.  Mechanism-design, social-choice, fair-division, and
auction developments sit on top of the same infrastructure, including
Bayesian games, a finite revelation principle, single-parameter
Myerson payment identities, Arrow and Gibbard--Satterthwaite, Sen's
liberal paradox, Vickrey/VCG truthfulness, knapsack auctions,
indivisible and divisible fair division, and contract-theory examples.
...
\input{sections/08-math-library}
