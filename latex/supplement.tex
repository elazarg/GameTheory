...
\noindent\TT{Concepts/Foundations/Transport/Deviation.lean} and
...
\noindent\TT{Concepts/Foundations/Transport/} (general theory) and
\TT{Concepts/Foundations/DeviationSimulation.lean} (pure-profile Nash corner)
...
(\TT{Concepts/Foundations/Transport/}, with the pure-profile Nash corner
and canonical-family corollaries in
\TT{Concepts/Foundations/DeviationSimulation.lean}) removes the need for
