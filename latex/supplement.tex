...
\Outcome.  The major theorem statements in this chapter still
impose finiteness on \Outcome\ where the proofs need it (so the
display reduces to a finite sum); a parallel \TT{\_of\_bounded}
family of lemmas in \TT{Math.Probability} and
\TT{Concepts/MixedExtension} replays the same identities under a
