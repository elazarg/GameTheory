...
player's two pure strategies by \TT{Bool}; the file proves the binary
PMF complement identity, expands mixed-extension EU over the four pure
label profiles, and defines the bundled witness
