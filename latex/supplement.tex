...
\subsection{Deviation-family schema: \texttt{Concepts/Equilibrium/GameFormSolutionConcepts.lean}}
...
\subsection{Deviation-simulation transport: \texttt{Concepts/Foundations/DeviationSimulation.lean}}
...
\paragraph{Regret.}\
\TT{Concepts/Correlation/Regret.lean}.  External regret of $\Profile$ for $i$
...
\TT{Concepts/Dominance/Rationalizability.lean},
\TT{Concepts/Dominance/DominanceSolvable.lean},
\TT{Concepts/Dominance/DominanceSolvability.lean}.  \TT{Survives n} is the
...
\TT{Concepts/Existence/ProductSimplexBrouwer.lean}) gives a fixed point
...
through a monotonicity-based induced social-welfare function.  Sen's
liberal paradox is not formalized; see chapter §10.
