...
argument (with an exact biconditional-dictator companion).  The
remaining classical impossibilities (Gibbard–Satterthwaite, Sen) are
not formalized; see chapter §10.
