...
\subsection{Deviation-family schema: \texttt{Concepts/GameFormSolutionConcepts.lean}}
...
\TT{Concepts/Babbling.lean} proves \TT{babbling\_nashFor},
...
(\TT{Concepts/GameFormSolutionConcepts.lean}) generalizes \eqref{eq:supp:isNash} to
...
(\TT{Concepts/GameMorphism.lean} and
\TT{Concepts/UtilityInvariance.lean}) states that a protocol map with
...
\TT{Concepts/BinaryMixed.lean} factors out the reusable part of the
...
\TT{Concepts/BinaryMixed.lean} theorem by labeling heads as \TT{true}
