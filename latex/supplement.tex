...
The embedding is payoff-faithful by construction, and the file
proves the structural facts (\TT{toFOSG\_terminal\_iff},
\TT{toFOSG\_active\_init}, \TT{toFOSG\_boundedHorizon}); a packaged
EU- or utility-distribution-equivalence theorem against the compiled
kernel game is not yet recorded.
