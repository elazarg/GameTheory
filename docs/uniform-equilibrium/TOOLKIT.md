...
| Punishment-floor predecessor orbit | An arbitrary finite quitting game; for the payoff conclusion, unbounded cumulative absorption on the selected exact predecessor orbit | One exact product-root predecessor orbit above the behavioral punishment floor; in the unbounded-charge branch, finite packets and a uniform payoff | The predecessor is selected by classical choice. Bounded charge is proved only for that orbit, not uniformly over every legal orbit, and the construction is not charge-optimal. |
