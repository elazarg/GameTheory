...
| Reusable mathematics and finite-support probability | complete | separate `GameTheory.Math` target; `GameTheory.Math.Probability.FinDist`; narrow `FinDist.toMeasure` product/bind bridge; simplex and pointwise-convergence interfaces; finite-index rotations; product projection and one-marginal mixture laws; support-dependent bind composition, event/fiber bounds, and informed binary stopping; support-preserving subtype transport and fibre conditioning; shared transcript sampling, correlated prefix reconstruction, and hidden-state coalescing with incoming-information rejection (`Tests.SequentialSampling`, `Tests.FinDistExtensions`); finite-law and stopping controls; D55/EXP-101, D57/EXP-117, and EXP-120 evidence | Further measurable mathematics remains consumer-gated; no universal probability abstraction or stopping-time theorem is introduced. |
...
| Kuhn correspondence | complete | bounded whole-profile laws plus finite-counterfactual-cover unilateral updated laws and Nash transfer without ambient information-state finiteness; EXP-115/116 infinite-carrier witnesses; EXP-117/D57 one regular forward product law over total pure policies; EXP-118/D58 reverse finite-own-record conditioning for arbitrary independent per-player policy measures; EXP-119/D59 both hybrid unilateral quantifiers preserving the original behavioral or arbitrary policy-law focal deviation; exact all-prefix and summable discounted consequences; thin perfect-monitoring stochastic corollaries | The unbounded `FinDist` convenience remains finite. Correlated joint player laws and infinite-path outcome semantics remain separate gates. |
