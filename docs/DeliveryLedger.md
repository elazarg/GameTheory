...
| Kuhn correspondence | complete | bounded whole-profile laws plus finite-counterfactual-cover unilateral updated laws and Nash transfer without ambient information-state finiteness; EXP-115/116 infinite-carrier witnesses; EXP-117/D57 one regular forward product law over total pure policies; EXP-118/D58 reverse finite-own-record conditioning for arbitrary independent per-player policy measures; exact all-prefix, unilateral-replacement, and summable discounted consequences in both measure directions; thin perfect-monitoring stochastic corollaries | The unbounded `FinDist` convenience remains finite. Correlated joint player laws and infinite-path outcome semantics remain separate gates. |
