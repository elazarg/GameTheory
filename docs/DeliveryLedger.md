...
| Kuhn correspondence | complete | bounded whole-profile laws plus finite-counterfactual-cover unilateral updated laws and Nash transfer without ambient information-state finiteness; finite perfect-recall EFG transfers; EXP-115/116 infinite-carrier witnesses; thin perfect-monitoring stochastic corollaries | The unbounded `FinDist` full-product convenience remains finite. Infinite-horizon realization needs a separately gated regular probability measure, not `FinDist`. |
...
| Stochastic games | supported | ordinary public-policy equivalence, chronological fixed-horizon laws, bounded behavioral/mixed Kuhn with exact unilateral and Nash transfer on the infinite public-history carrier, exact proof-free/canonical average-payoff transport, uniform-cap characterization, arbitrary-horizon restart, action-dependent migration fixture, nonconstant transient uniform-payoff certificate, discounted values, stationary Bellman equilibrium | No stable infinite-path policy law or general uniform-existence claim. EXP-108/113 validate an experiment-only infinite-play outcome measure with exact canonical finite marginals and a fair absorbing game whose expected finite averages converge to `1/2` and whose expected pathwise liminf/limsup are both `1/2`. Infinite-horizon Kuhn and cyclic terminal/limiting-average/uniform interfaces remain separate and open. Further specialized continuation algebra is consumer-gated. |
