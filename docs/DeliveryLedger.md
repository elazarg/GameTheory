...
| Kuhn correspondence | complete | bounded whole-profile laws with no ambient information-state finiteness; protocol-level unilateral updated-law equivalence; two-player EFG witness transfers expected-utility Nash in both directions; EXP-115 infinite-carrier witness | Exact updated-law and Nash transfer remain in the finite perfect-recall scope; broader convenience results are separate. |
