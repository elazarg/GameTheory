...
| Execution and information | complete | `GameTheory.Protocol`; terminal-or-fuel support invariant and arbitrary-start certified-horizon absorption; `Protocol.Predraw` one-participant finite-table and profile-local existential history laws; two-round randomized-opponent and execution/information tests | No second runner or universal semantic hub. |
