...
| Kuhn correspondence | complete | bounded whole-profile laws plus finite-counterfactual-cover unilateral updated laws and Nash transfer without ambient information-state finiteness; EXP-115/116 infinite-carrier witnesses; EXP-117/D57 one regular product law over total pure policies with exact finite marginals, all covered finite-prefix laws, behavioral unilateral replacements, and summable discounted consequences; thin perfect-monitoring stochastic corollaries | The unbounded `FinDist` convenience remains finite. Reverse conditionalization of an arbitrary regular pure-policy law and infinite-path outcome semantics remain separate gates. |
