...
| Prove/check dominance, rationalizability, and response properties | `Concepts/Dominance/**` (S-DOM); response material in S-FOUND | [`GameTheory/Core/Response.lean`](../GameTheory/Core/Response.lean), finite dominance checks, and the complete [15-row strict-solvability ledger](coverage/S-DOM-strict-solvability.md) | partial | Recover mixed domination/rationalizability, IESDS/correlation, undominated existence/counterexamples, and transform laws in bounded turns. |
...
| Formalize social-choice impossibility and rule-characterization workflows | `Mechanism/SocialChoice/**` (M-SOCIAL) | [`GameTheory/Core/SocialChoice.lean`](../GameTheory/Core/SocialChoice.lean), [`GameTheory/Core/Arrow.lean`](../GameTheory/Core/Arrow.lean), and [`GameTheory/Core/May.lean`](../GameTheory/Core/May.lean) provide ranking foundations, Arrow impossibility, and the complete binary majority characterization; [15/15 May ledger](coverage/M-SOCIAL-may.md) | partial | Add Gibbard--Satterthwaite and Sen without merging rankings into lottery preference; audit the remaining ranking and median-voter inventory. |
| State coalitional values, core, Shapley allocations, and voting power indices | `Core/Coalition.lean`, `Cooperative/CoalitionalGame/**` (P-COAL) | [`GameTheory/Core/Coalitional.lean`](../GameTheory/Core/Coalitional.lean), [`GameTheory/Core/Shapley.lean`](../GameTheory/Core/Shapley.lean), and [`GameTheory/Cooperative/Banzhaf.lean`](../GameTheory/Cooperative/Banzhaf.lean) provide the canonical carrier, Shapley characterization, raw Banzhaf value, and simple-game Shapley--Shubik index; [11/11 power-index ledger](coverage/P-COAL-banzhaf.md) | partial | Recover convex-core, Bondareva balancedness, and cost-of-stability theorems without reconstructing a second coalitional-game wrapper. |
