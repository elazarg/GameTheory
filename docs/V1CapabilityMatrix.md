...
| Prove fictitious-play convergence and approachability/regret consequences | fictitious-play and approachability files in `Concepts/Learning/**` (D-LEARN) | [`GameTheory/Core/FictitiousPlay.lean`](../GameTheory/Core/FictitiousPlay.lean) and [`GameTheory/Core/FictitiousPlayPotential.lean`](../GameTheory/Core/FictitiousPlayPotential.lean) expose canonical gains and nonzero empirical-potential recurrences; [`GameTheory/Analysis/Learning.lean`](../GameTheory/Analysis/Learning.lean) proves every pointwise belief limit is mixed Nash | critical gap | Complete the finite exact-potential boundedness/summability chain, then recover the approachability bridge without duplicating regret semantics. |
