...
| Prove fictitious-play convergence and approachability/regret consequences | fictitious-play and approachability files in `Concepts/Learning/**` (D-LEARN) | [`GameTheory/Core/FictitiousPlay.lean`](../GameTheory/Core/FictitiousPlay.lean) and [`GameTheory/Core/FictitiousPlayPotential.lean`](../GameTheory/Core/FictitiousPlayPotential.lean) expose the complete topology-free gain/recurrence/Lyapunov spine on a nonzero trace; [`GameTheory/Analysis/Learning.lean`](../GameTheory/Analysis/Learning.lean) proves every pointwise belief limit is mixed Nash | critical gap | Complete the summability and vanishing-improvement Analysis chain, then recover the approachability bridge without duplicating regret semantics. |
