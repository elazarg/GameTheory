...
Canonical destination: `GameTheory.Core.Response`; `GameTheory.Core.Utility`
Domain contract / decision: D4-D5
Owner: Wave 2 / foundations recovery
Status: in progress; 7 bounded declarations reviewed
...
Disposition count: 4 adapt; 3 subsumed.
...
the canonical static game form.

Validation:

```text
lake build GameTheory.Core.Utility GameTheory.Core.Response
```
