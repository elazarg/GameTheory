...
| D-COMM | `Concepts/Communication/**`, `Core/Babbling.lean`, `Languages/ElectronicMailGame.lean` | 5 | static core or Protocol according to timing | observable one-stage cheap talk validated by EXP-046/D18 | partial; 0/87 declarations reviewed | [exact declaration ledger](coverage/D-COMM-communication.md); public randomness and Electronic Mail must choose static or Protocol ownership from theorem-observable timing |
