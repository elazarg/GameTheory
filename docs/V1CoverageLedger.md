...
| ID | Pinned scope | Files | Intended successor owner | Integration | Recovery | Next gate |
|---|---|---:|---|---|---|---|
| M-BAYES | `Mechanism/Bayesian.lean`, `Mechanism/Bayesian/**` | 12 | Bayesian data/equilibrium plus coordinated mechanism modules | validated split; F5/F6, canonical revelation, and finite information design complete | partial; revelation 6/6 and information design 21/21 reviewed | [revelation ledger](coverage/M-BAYES-revelation.md); [information-design ledger](coverage/M-BAYES-information-design.md); next welfare/participation and remaining mechanism inventory |
