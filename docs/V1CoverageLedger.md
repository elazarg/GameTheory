...
| ID | Pinned scope | Files | Intended successor owner | Integration | Recovery | Next gate |
|---|---|---:|---|---|---|---|
| M-BAYES | `Mechanism/Bayesian.lean`, `Mechanism/Bayesian/**` | 12 | Bayesian data/equilibrium plus coordinated mechanism modules | validated split; F5/F6, canonical revelation, finite information design, and truthful welfare/participation complete | partial; revelation 6/6, information design 21/21, and mechanism design 15/15 reviewed | [revelation ledger](coverage/M-BAYES-revelation.md); [information-design ledger](coverage/M-BAYES-information-design.md); [truthful welfare/participation ledger](coverage/M-BAYES-mechanism-welfare.md); next feasible posteriors, monotonicity, and remaining mechanism inventory |
