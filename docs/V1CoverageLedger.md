...
| ID | Pinned scope | Files | Intended successor owner | Integration | Recovery | Next gate |
|---|---|---:|---|---|---|---|
| D-LEARN | `Concepts/Learning/**` | 8 | stable finite identities in Core; quantitative composition in `Analysis.Learning` | validated by F2 and EXP-049/D21 | partial; finite/MW self-play 15/15 and fictitious-play trajectory core 9/9 reviewed | [self-play ledger](coverage/D-LEARN-self-play.md), [fictitious-play ledger](coverage/D-LEARN-fictitious-play.md); next the two base convergence obligations, potential-game convergence, then approachability |
