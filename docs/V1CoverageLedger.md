...
| S-DOM | `Concepts/Dominance/**` | 9 | `Core.Response` and finite correctness | validated | partial; strict-dominance/dominant-solvability spine 15/15 reviewed | [strict-solvability ledger](coverage/S-DOM-strict-solvability.md); next mixed domination/rationalizability, IESDS/correlation, undominated existence/counterexamples, and transform laws |
