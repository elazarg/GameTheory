...
| D-COMM | `Concepts/Communication/**`, `Core/Babbling.lean`, `Languages/ElectronicMailGame.lean` | 5 | static core or Protocol according to timing | one-stage cheap talk and mixed correlation validated by EXP-046/D18 and EXP-047/D19 | partial; 62/87 declarations reviewed, 19 cross-family rows deferred | [exact declaration ledger](coverage/D-COMM-communication.md); pure babbling, exact Nash outcome laws, and mixed-Nash-to-CE recovered; conditional public-signal representation and Electronic Mail remain |
