...
| D-COMM | `Concepts/Communication/**`, `Core/Babbling.lean`, `Languages/ElectronicMailGame.lean` | 5 | static core or Protocol according to timing | observable one-stage cheap talk validated by EXP-046/D18 | partial; 32/87 declarations reviewed, 2 cross-family rows deferred | [exact declaration ledger](coverage/D-COMM-communication.md); pure babbling and exact Nash outcome-law preservation recovered; public randomness and Electronic Mail must choose ownership from theorem-observable timing |
