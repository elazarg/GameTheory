...
| Model deterministic repeated play, public-signal monitoring, discounting, triggers, PPE, and uniform equilibrium | [`GameTheory/Repeated.lean`](../GameTheory/Repeated.lean), [`GameTheory/Tests/MonitoringEquilibrium.lean`](../GameTheory/Tests/MonitoringEquilibrium.lean), [`GameTheory/Tests/RepeatedUniform.lean`](../GameTheory/Tests/RepeatedUniform.lean) | supported | Deterministic prefixes compile to Protocol; native monitoring histories are a distinct finite recursion; neither claims an infinite realized-path law. |
