...
The audit now indexes 436 files and 8,324 declarations. Fifteen work-package
ledgers claim 1,216 declarations: 440 have reviewed dispositions, the exact
FOSG queue contains 776 deliberately seeded `unreviewed` rows, and 7,108 remain
...
|---|---|---|
| NFG | **passed and accounted:** EXP-042/T4 validates compilation; all 126 pinned declarations are classified, with three substantive cross-family rows routed to S-MIX, S-CORR, and S-ZERO | broad example, observable cheap-talk, and fair mixed-Nash-to-CE recovery are complete; deliver the remaining mixed and constant-sum correlation theorems in their owning lanes |
...
4. continue broad FOSG recovery, decide whether a live consumer earns D-COMM's
   ...
   S-MIX and constant-sum S-CORR/S-ZERO consumers routed by the completed NFG
   ledger;
