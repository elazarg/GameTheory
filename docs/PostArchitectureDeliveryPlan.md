...
5. **in progress:** canonical finite-support revelation, all 21 declarations in
   ...
   validates quasilinear ownership and leaves stable monotonicity promotion as
   the next narrow gate, while the remaining 81-row
