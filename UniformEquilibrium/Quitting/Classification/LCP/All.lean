...
/-!
# LCP classification layer for finite quitting games

This umbrella exports the faithful standard-Q/projective-Q split, the exact
playerwise normalization, the recursive normal-player matrix, audited source
interfaces, and the ordinary/continuous/residual gate.
-/
